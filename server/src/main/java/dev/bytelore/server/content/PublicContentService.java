...
import dev.bytelore.server.content.dto.CodeExampleResponse;
import dev.bytelore.server.content.dto.LessonDetailResponse;
import dev.bytelore.server.content.dto.LessonModuleRef;
import dev.bytelore.server.content.dto.LessonSummaryResponse;
import dev.bytelore.server.content.dto.LessonTrackRef;
import dev.bytelore.server.content.dto.MindMapNodeResponse;
import dev.bytelore.server.content.dto.MindMapResponse;
import dev.bytelore.server.content.dto.ModuleSummaryResponse;
import dev.bytelore.server.content.dto.ProgressResponse;
